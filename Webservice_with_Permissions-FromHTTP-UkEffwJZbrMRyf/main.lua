...
function SetupActions()
   ...
   AdminActions[""] = CustomerList
   AdminActions["add_customer"] = AddCustomer
   AdminActions["add_customer_data"] = ProcessAddCustomer
   AdminActions["delete_customer"] = deleteCustomer
   -- Define user actions
